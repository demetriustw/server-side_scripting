...
function updateFirstAndLastName(firstAndLastNameClass) {
  var firstAndLastNameValue = $("." + firstAndLastNameClass).val();

  $.post("includes/handlers/ajax/firstAndLastName.php", {
    firstAndLastName: firstAndLastNameValue,
    username: userLoggedIn,
  }).done(function (response) {
    $("." + firstAndLastNameClass)
      .nextAll(".message")
      .text(response);
  });
}
